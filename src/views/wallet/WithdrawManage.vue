  ...
  <div class="content-panel">
    ...
    <div class="panel-body">
      <div class="filter-bar">
        <div class="filter-item"><label>搜索</label><input type="text" class="form-input" v-model="withdrawSearchForm.keyword" placeholder="提现单号 / UID / 关联支付单号单号号" style="width: 220px" /></div>
      ...
      <table class="data-table">
        <thead><tr><th>提现单号</th><th>用户</th><th>提现金额</th><th>关联支付单号单号</th><th>关联支付单号</th><th>状态</th><th>操作</th></tr></thead>
        <tbody>
      ...
      <div class="modal-content modal-md">
        ...
        <div class="modal-body" v-if="withdrawDetailItem">
          <div class="detail-grid">
            ...
            <div><label>关联支付单号单号</label><span>{{ withdrawDetailItem.relatedOrderNo }}</span></div>
